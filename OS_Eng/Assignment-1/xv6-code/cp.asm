...
main(int argc, char *argv[])
{
  ...
  24:	e8 79 03 00 00       	call   3a2 <open>
  29:	83 c4 10             	add    $0x10,%esp
  2c:	85 c0                	test   %eax,%eax
  2e:	89 c6                	mov    %eax,%esi
  30:	78 58                	js     8a <main+0x8a>
  ...
  3c:	e8 61 03 00 00       	call   3a2 <open>
  41:	83 c4 10             	add    $0x10,%esp
  44:	85 c0                	test   %eax,%eax
  46:	89 c7                	mov    %eax,%edi
  48:	78 23                	js     6d <main+0x6d>
      close(fd);
      exit();
  }
  ...
  4c:	57                   	push   %edi
  4d:	56                   	push   %esi
  4e:	e8 4d 00 00 00       	call   a0 <cp>

  //Close files and exit
  close(fd);
  53:	89 34 24             	mov    %esi,(%esp)
  56:	e8 2f 03 00 00       	call   38a <close>
  close(fd1);
  5b:	89 3c 24             	mov    %edi,(%esp)
  5e:	e8 27 03 00 00       	call   38a <close>
  exit();
  63:	e8 fa 02 00 00       	call   362 <exit>
{
  int fd, fd1;
  ...
  if(argc <= 1){
    exit();
  68:	e8 f5 02 00 00       	call   362 <exit>
      exit();
  }
  ...
  if((fd1 = open(argv[2], O_CREATE|O_RDWR)) < 0){
      printf(1, "cat: cannot open %s\n", argv[2]);
  6d:	52                   	push   %edx
  6e:	ff 73 08             	pushl  0x8(%ebx)
  71:	68 01 08 00 00       	push   $0x801
  76:	6a 01                	push   $0x1
  78:	e8 43 04 00 00       	call   4c0 <printf>
      close(fd);
  7d:	89 34 24             	mov    %esi,(%esp)
  80:	e8 05 03 00 00       	call   38a <close>
      exit();
  85:	e8 d8 02 00 00       	call   362 <exit>
    exit();
  }
  ...
  if((fd = open(argv[1], 0)) < 0){
      printf(1, "cat: cannot open %s\n", argv[1]);
  8a:	56                   	push   %esi
  8b:	ff 73 04             	pushl  0x4(%ebx)
  8e:	68 01 08 00 00       	push   $0x801
  93:	6a 01                	push   $0x1
  95:	e8 26 04 00 00       	call   4c0 <printf>
      exit();
  9a:	e8 c3 02 00 00       	call   362 <exit>
  9f:	90                   	nop
...
cp(int fd, int fd1)
{
  ...
  a9:	8b 75 08             	mov    0x8(%ebp),%esi
  ac:	8b 7d 0c             	mov    0xc(%ebp),%edi
  int n;

  while((n = read(fd, buf, sizeof(buf))) > 0) {
  af:	eb 1d                	jmp    ce <cp+0x2e>
  b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if (write(fd1, buf, n) != n) {
  b8:	83 ec 04             	sub    $0x4,%esp
  bb:	53                   	push   %ebx
  bc:	68 20 0b 00 00       	push   $0xb20
  c1:	57                   	push   %edi
  c2:	e8 bb 02 00 00       	call   382 <write>
  c7:	83 c4 10             	add    $0x10,%esp
  ca:	39 c3                	cmp    %eax,%ebx
  cc:	75 27                	jne    f5 <cp+0x55>
void
cp(int fd, int fd1)
{
  int n;
  ...
  d6:	68 20 0b 00 00       	push   $0xb20
  db:	56                   	push   %esi
  dc:	e8 99 02 00 00       	call   37a <read>
  e1:	83 c4 10             	add    $0x10,%esp
  e4:	83 f8 00             	cmp    $0x0,%eax
  e7:	89 c3                	mov    %eax,%ebx
  e9:	7f cd                	jg     b8 <cp+0x18>
    if (write(fd1, buf, n) != n) {
  ...
  f4:	c3                   	ret    
{
  ...
  f8:	68 e0 07 00 00       	push   $0x7e0
  fd:	6a 01                	push   $0x1
  ff:	e8 bc 03 00 00       	call   4c0 <printf>
      exit();
 104:	e8 59 02 00 00       	call   362 <exit>
    }
  }
  if(n < 0){
    printf(1, "cp: read error\n");
 109:	83 ec 08             	sub    $0x8,%esp
 10c:	68 f1 07 00 00       	push   $0x7f1
 111:	6a 01                	push   $0x1
 113:	e8 a8 03 00 00       	call   4c0 <printf>
    exit();
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 16 08 00 00       	mov    $0x816,%eax
