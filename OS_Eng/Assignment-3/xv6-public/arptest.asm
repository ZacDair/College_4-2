...
int main(void) {
  ...
  11:	6a 12                	push   $0x12
  13:	e8 48 06 00 00       	call   660 <malloc>
  if(arp("mynet0", ip, mac, MAC_SIZE) < 0) {
  18:	6a 12                	push   $0x12
  1a:	50                   	push   %eax
  1b:	68 58 07 00 00       	push   $0x758
  20:	68 61 07 00 00       	push   $0x761
  25:	e8 18 03 00 00       	call   342 <arp>
  2a:	83 c4 20             	add    $0x20,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	78 05                	js     36 <main+0x36>
  ...
  31:	e8 6c 02 00 00       	call   2a2 <exit>
    printf(1, "ARP for IP:%s Failed.\n", ip);
  36:	50                   	push   %eax
  37:	68 58 07 00 00       	push   $0x758
  3c:	68 68 07 00 00       	push   $0x768
  41:	6a 01                	push   $0x1
  43:	e8 b8 03 00 00       	call   400 <printf>
  48:	83 c4 10             	add    $0x10,%esp
  4b:	eb e4                	jmp    31 <main+0x31>
  4d:	66 90                	xchg   %ax,%ax
  4f:	90                   	nop
