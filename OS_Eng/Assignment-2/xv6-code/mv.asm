...
main(int argc, char *argv[])
{
  ...
  21:	e8 ec 02 00 00       	call   312 <unlink>
  ...
  30:	e8 cd 02 00 00       	call   302 <open>
  35:	83 c4 10             	add    $0x10,%esp
  38:	85 c0                	test   %eax,%eax
  3a:	89 c6                	mov    %eax,%esi
  3c:	78 28                	js     66 <main+0x66>
  ...
  46:	e8 d7 02 00 00       	call   322 <link>
  unlink(argv[1]);
  4b:	5a                   	pop    %edx
  4c:	ff 73 04             	pushl  0x4(%ebx)
  4f:	e8 be 02 00 00       	call   312 <unlink>

  //Close files and exit
  close(fd);
  54:	89 34 24             	mov    %esi,(%esp)
  57:	e8 8e 02 00 00       	call   2ea <close>
  exit();
  5c:	e8 61 02 00 00       	call   2c2 <exit>
{
  ...
  if((fd = open(argv[1], O_CREATE|O_RDWR)) < 0){
      printf(1, "mv: cannot open %s\n", argv[1]);
  66:	51                   	push   %ecx
  67:	ff 73 04             	pushl  0x4(%ebx)
  6a:	68 40 07 00 00       	push   $0x740
  6f:	6a 01                	push   $0x1
