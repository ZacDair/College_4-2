...
int main(int argc, char *argv[]){
  ...
  11:	8d 85 a8 fe ff ff    	lea    -0x158(%ebp),%eax
    char name[16];
};
...
extern int getprocs(int, struct uproc[10]);
int main(int argc, char *argv[]){
  17:	81 ec 50 01 00 00    	sub    $0x150,%esp
    struct uproc ptable[MAX_PROC];
    //struct uproc *p;
    int numProc, i;
  ...
  1d:	50                   	push   %eax
  1e:	6a 0a                	push   $0xa
  20:	e8 75 03 00 00       	call   39a <getprocs>
    if(numProc == 0){
  25:	83 c4 10             	add    $0x10,%esp
  28:	83 f8 00             	cmp    $0x0,%eax
int main(int argc, char *argv[]){
    struct uproc ptable[MAX_PROC];
    //struct uproc *p;
    int numProc, i;
  ...
  2b:	89 c6                	mov    %eax,%esi
    if(numProc == 0){
  2d:	74 66                	je     95 <main+0x95>
        printf(1, "Error getting ptable");
    }
    else{
        //Output the process details
        for(i = 0; i<numProc && ptable[i].state != 0; i++){
  2f:	7e 4f                	jle    80 <main+0x80>
  31:	8b 85 b0 fe ff ff    	mov    -0x150(%ebp),%eax
  37:	31 ff                	xor    %edi,%edi
  39:	8d 9d b8 fe ff ff    	lea    -0x148(%ebp),%ebx
  3f:	85 c0                	test   %eax,%eax
  41:	75 0f                	jne    52 <main+0x52>
  43:	eb 3b                	jmp    80 <main+0x80>
  45:	8d 76 00             	lea    0x0(%esi),%esi
  48:	83 c3 20             	add    $0x20,%ebx
  4b:	8b 43 f8             	mov    -0x8(%ebx),%eax
  ...
  55:	83 ec 04             	sub    $0x4,%esp
    if(numProc == 0){
        ...
        //Output the process details
        for(i = 0; i<numProc && ptable[i].state != 0; i++){
  58:	83 c7 01             	add    $0x1,%edi
            printf(1, "PID= %d  PPID= %d  State= %s  Size= %d  Name= %s\n", ptable[i].pid, ptable[i].ppid, procstateNames[ptable[i].state], ptable[i].sz, ptable[i].name);
  5b:	53                   	push   %ebx
  5c:	ff 73 fc             	pushl  -0x4(%ebx)
  5f:	8d 84 00 a0 0a 00 00 	lea    0xaa0(%eax,%eax,1),%eax
  66:	50                   	push   %eax
  67:	ff 73 f4             	pushl  -0xc(%ebx)
  6a:	ff 73 f0             	pushl  -0x10(%ebx)
  6d:	68 88 07 00 00       	push   $0x788
  72:	6a 01                	push   $0x1
  ...
  7c:	39 fe                	cmp    %edi,%esi
  7e:	75 c8                	jne    48 <main+0x48>
            printf(1, "PID= %d  PPID= %d  State= %s  Size= %d  Name= %s\n", ptable[i].pid, ptable[i].ppid, procstateNames[ptable[i].state], ptable[i].sz, ptable[i].name);
        }
    }
  ...
  83:	56                   	push   %esi
  84:	68 bc 07 00 00       	push   $0x7bc
  89:	6a 01                	push   $0x1
  8b:	e8 c0 03 00 00       	call   450 <printf>
    exit();
  ...
  95:	50                   	push   %eax
  96:	50                   	push   %eax
  97:	68 70 07 00 00       	push   $0x770
  9c:	6a 01                	push   $0x1
  9e:	e8 ad 03 00 00       	call   450 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 dc 07 00 00       	mov    $0x7dc,%eax
...
free(void *ap)
{
 ...
 5f1:	a1 dc 0a 00 00       	mov    0xadc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 dc 0a 00 00       	mov    %eax,0xadc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6df:	76 3f                	jbe    720 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	39 05 dc 0a 00 00    	cmp    %eax,0xadc
 ...
 706:	e8 e5 fe ff ff       	call   5f0 <free>
  return freep;
 70b:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 dc 0a 00 00    	mov    %edx,0xadc
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 74d:	0a 00 00 
 750:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 e0 0a 00 00       	mov    $0xae0,%eax
 75f:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 766:	00 00 00 
