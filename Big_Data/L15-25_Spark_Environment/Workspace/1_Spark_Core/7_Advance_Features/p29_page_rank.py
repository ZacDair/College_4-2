...
# FUNCTION page_rank
# ------------------------------------------
def page_rank(sc, reset_probability, max_iterations):
    ...
    linksRDD = sc.parallelize([("A", ["B", "D", "E"]),
                               ...
                               ]).partitionBy(max_iterations).persist()
    ...
    for i in range(max_iterations):
        ...
        ranksRDD = totalContributionsRDD.mapValues(lambda x: reset_probability + ((1.0-reset_probability) * x))
...
# FUNCTION my_main
# ------------------------------------------
def my_main(sc, reset_probability, max_iterations):
    #print("--- count_users_clicking_new_links ---")
    #count_users_clicking_new_links(sc)

    print("--- page_rank ---")
    page_rank(sc, reset_probability, max_iterations)
...
if __name__ == '__main__':
    ...
    my_main(sc, reset_probability, max_iterations)
