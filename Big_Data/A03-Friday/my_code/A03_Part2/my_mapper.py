...
def my_map(my_input_stream, my_output_stream, my_mapper_input_parameters):
    ...
    for line in my_input_stream:
        ...
        if data[2] > longestTrip:
            longestTrip = data[2]
            longestTripID = data[15]
            '''
                NOTE: I noticed that the test was failing for the sort_1.txt due to your usage of the last occurring
                 largest trip, hence the addition of the ELIF below
            '''
        elif data[2] == longestTrip:
            longestTrip = data[2]
            longestTripID = data[15]
    # Output to file
    res = "universal" + "\t" + "(" + str(longestTripID) + ", " + str(longestTrip) + ")" + "\n"
