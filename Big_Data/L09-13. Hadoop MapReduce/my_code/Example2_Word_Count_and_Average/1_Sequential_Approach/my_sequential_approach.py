...
def my_main(input_folder, output_file):
    ...
    for file in list_of_files:
        ...
        for line in my_input_stream:
            ...
            for w in words:
                ...
                # III. Update the dictionary with the new word
    ...
    for key in sorted(my_letter_words_dict):
        # 5.1. We get the value from the dictionary
        (num_words, total_length_words) = my_letter_words_dict[key]

        # 5.2. We get the average length
        avg_length_words = round( total_length_words / (num_words * 1.0), 2 )

        # 5.3. We create the String
        my_str = key + "\t" + "(" + str(num_words) + ", " + str(total_length_words) + ", " + str(avg_length_words) + ")" + "\n"

        # 5.4. We write it to the file
...
if __name__ == '__main__':
    ...
    output_file = "../../../my_results/Example2_Word_Count_and_Average/1_Sequential_Approach/result.txt"
